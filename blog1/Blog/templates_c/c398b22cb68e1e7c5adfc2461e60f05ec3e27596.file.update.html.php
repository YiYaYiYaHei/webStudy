<?php /* Smarty version Smarty-3.1.8, created on 2018-10-05 03:36:31
         compiled from "./View\admin\user\update.html" */ ?>
<?php /*%%SmartyHeaderCode:179615bae3353e0c4c8-54539668%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c398b22cb68e1e7c5adfc2461e60f05ec3e27596' => 
    array (
      0 => './View\\admin\\user\\update.html',
      1 => 1538143676,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '179615bae3353e0c4c8-54539668',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5bae3353ea88f3_61142140',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bae3353ea88f3_61142140')) {function content_5bae3353ea88f3_61142140($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<form action="index.php?c=user&a=doedit" method="post">
		<div class="form-group">
		    <input type="hidden" class="form-control" id="exampleInputEmail1" placeholder="id" name="id" value="<?php echo $_smarty_tpl->tpl_vars['res']->value['id'];?>
">
	  </div>
	  <div class="form-group">
	    <label for="exampleInputEmail1">Username:</label>
	    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="username" name="username" value="<?php echo $_smarty_tpl->tpl_vars['res']->value['username'];?>
">
	  </div>
	  <div class="form-group">
	    <label for="exampleInputPassword1">Password</label>
	    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password" name="password" value="<?php echo $_smarty_tpl->tpl_vars['res']->value['password'];?>
">
	  </div>

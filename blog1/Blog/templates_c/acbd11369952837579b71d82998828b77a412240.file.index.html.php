<?php /* Smarty version Smarty-3.1.8, created on 2018-10-05 03:36:29
         compiled from "./View\admin\user\index.html" */ ?>
<?php /*%%SmartyHeaderCode:294755bae1c46abe7a6-98121287%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'acbd11369952837579b71d82998828b77a412240' => 
    array (
      0 => './View\\admin\\user\\index.html',
      1 => 1538289863,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '294755bae1c46abe7a6-98121287',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5bae1c46af9133_15243026',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bae1c46af9133_15243026')) {function content_5bae1c46af9133_15243026($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<!-- 使用循环遍历数据库数据 smarty中使用到php用{}括起来-->
...
" class="btn btn-info">修改</a>
	...
	<script>
			...
			function fun(id){
				$.get("index.php?c=user&a=del",{id:id},function(data){
					if(data){
						$('#tr'+id).remove();
					}else{
						alert("删除失败");

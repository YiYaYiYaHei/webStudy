<?php /* Smarty version Smarty-3.1.8, created on 2018-10-05 15:20:18
         compiled from "./View\admin\article\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:33895bb6f67b17e498-68133876%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f74e4dd23d203a19d92b08979f60199e3adc130f' => 
    array (
      0 => './View\\admin\\article\\edit.html',
      1 => 1538724004,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '33895bb6f67b17e498-68133876',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5bb6f67b284056_77490563',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bb6f67b284056_77490563')) {function content_5bb6f67b284056_77490563($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<form action="index.php?c=article&a=doedit" method="post">
  <input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['info']->value['id'];?>
">
  <input type="hidden" name="oldpic" value="<?php echo $_smarty_tpl->tpl_vars['info']->value['picname'];?>
">
  <div class="form-group">
    <label for="exampleInputEmail1">标题：</label>
    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="title" name="title" value="<?php echo $_smarty_tpl->tpl_vars['info']->value['title'];?>
">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">内容：</label>
    <textarea class="form-control" rows="3" id="exampleInputPassword1" name="content" placeholder="文章内容"><?php echo $_smarty_tpl->tpl_vars['info']->value['content'];?>
</textarea>
  </div>
  <div class="form-group">
...
?>
      <?php if ($_smarty_tpl->tpl_vars['v']->value['status']==1){?>
        <?php if ($_smarty_tpl->tpl_vars['v']->value['id']==$_smarty_tpl->tpl_vars['info']->value['type_id']){?>
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
      ...
      <?php }else{ ?>
         <?php if ($_smarty_tpl->tpl_vars['v']->value['id']==$_smarty_tpl->tpl_vars['info']->value['type_id']){?>
          <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" selected disabled style="color: red;"><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
</option>
        <?php }else{ ?>
          <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" disabled style="color: red;"><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
</option>
        <?php }?>
      <?php }?>
